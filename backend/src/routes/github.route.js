...
router.get("/auth", (req, res) => {
  const redirectUrl = `https://github.com/login/oauth/authorize?client_id=${process.env.GITHUB_CLIENT_ID}&redirect_uri=https://irretrievable-kody-tardily/api/github/callback&scope=repo,user`;
